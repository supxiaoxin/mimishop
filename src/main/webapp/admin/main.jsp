	...
	<body>
		...
		<div id="all">
			...
			<div id="bottom">
				...
				<!--下部分右边-->
				<div id="bright">
					<iframe src="${pageContext.request.contextPath}/prod/split.action" frameborder="0" scrolling="yes" id="iframe" name="myright" width="1235px" height="700px" ></iframe>
