...
import com.mys.mapper.ProductInfoMapper;
import com.mys.pojo.ProductInfo;
import com.mys.pojo.ProductInfoExample;
import com.mys.pojo.vo.ProductInfoVo;
import com.mys.service.ProductInfoService;
...
public class ProductInfoServiceImpl implements ProductInfoService {
    ...
    public PageInfo<ProductInfo> splitPageVo(ProductInfoVo vo, int pageSize) {
        ...
        PageHelper.startPage(vo.getPage(),pageSize);//设置分页的显示页数，每页条数
